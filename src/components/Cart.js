                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-7 col-lg-8">
                        ...
                        <form>
                            ...
                            <button className="btn btn-primary btn-lg btn-block" type="submit" disabled={ !name || !phone || !email || (emailConfirm !== email) || sent } onClick={createOrder} style={{ marginBottom: '30px'}}>
                                Realizar compra
                            </button>
                        </form>
                    </div>
