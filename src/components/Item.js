...
export default function Item() {
    return new Promise((res, rej) => {
        setTimeout(() => {
        res([{ id: '1', categoryId: 'tortas', name: 'Torta Bombón', img:`${tortabombon}`, description:'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vitae suscipit tellus mauris a diam maecenas sed.', price: 1000},
            ...
            { id: '3', categoryId: 'tartas', name: 'Tarta de Frutilla', img:`${tartafrutilla}`, description:'Loren impsun 3Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', price: 720},
            ...
            { id: '6', categoryId: 'tortas', name: 'Lujuria de Chocolate', img:`${lujuriachocolate}`, description:'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ua.', price: 890},
            ]);
        }, 3000);
    });
}
