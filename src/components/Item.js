...
export default function Item() {
    return new Promise((res, rej) => {
        setTimeout(() => {
        res([{ id: 1, name: 'Torta Bombón', img:`${tortabombon}`, description:'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vitae suscipit tellus mauris a diam maecenas sed.', price: '$ 1.000'},
